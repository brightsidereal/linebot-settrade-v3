...
lineaccesstoken = 'rvUYAf4COAIYh87ztks7iLuVX6Bx+EJcEcWuDObeU5ysxrR0PrVFAiHy6dE0xIeqPtTn8WkqZJUVW1uSdX82WsLI8PnaMLxWpL/ELamn37cBFxdiwOGHzi7ibBx/rivF2IUIm5uV2zgzTWqJG7BpkgdB04t89/1O/w1cDnyilFU=n'
line_bot_api = LineBotApi(lineaccesstoken)
handler = WebhookHandler('cbcfbac2b2a834257a58b5308c429adc')
investor = Investor(
    app_id="huuYG6HME0J0BRJG",
    app_secret="RGjdF6cLJziWz7g5TH04UrLz/0CTIDVo4eo4YRj+KJ0=",
    broker_id="SANDBOX",
    app_code="SANDBOX",
    is_auto_queue=False)
equity = investor.Equity(account_no="brightsd-E")
